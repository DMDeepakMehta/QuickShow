  ...
  return (
    ...
    bg-cover bg-center h-screen'>
       ...
       <div className='flex items-center gap-4 text-gray-300'>
            <spn>Action | Adventure | Sci-Fi</spn>
       ...
       <p className='max-w-md text-gray-300'>In a post-apocalyptic world where cities ride 
        on wheels and consume each other to survive, two people meet in 
